...
**System Engineering Student @ UTP | Founder & Lead Engineer @ Velaris**

---

### 🛠️ Core Engineering Stack

- **Languages:** C++, Python, Rust, JS, Java, SQL.
- **Web Infrastructure:** Astro (SSG), Tailwind CSS, React, Cloudflare Edge.
- **Systems & DevOps:** Linux, Docker, GitHub Actions.
